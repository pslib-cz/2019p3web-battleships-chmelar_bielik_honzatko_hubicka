        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerState = table.Column<int>(nullable: false),
                    PlayerState = table.Column<int>(nullable: false),
                    Player1Board = table.Column<int>(nullable: false),
                    Player2Board = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NavyBattlePieces_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "GameId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NavyBattlePieces_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NavyBattlePieces_GameId",
                table: "NavyBattlePieces",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_NavyBattlePieces_UserId",
                table: "NavyBattlePieces",
                column: "UserId");
        }
